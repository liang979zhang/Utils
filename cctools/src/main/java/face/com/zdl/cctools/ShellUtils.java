...
public class ShellUtils {
    ...
    /**
     * checkRootPermission() 检查root权限 。execCommand(String[] commands, boolean isRoot, boolean isNeedResultMsg)
     * shell 环境执行命令，第二个参数表示是否root权限执行 execCommand(String command, boolean isRoot) shell环境执行命令
     * @return
     */
